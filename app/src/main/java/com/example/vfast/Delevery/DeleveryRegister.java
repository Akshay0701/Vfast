...
public class DeleveryRegister extends AppCompatActivity {



    private SharedPreferences sharedPreferences;
    SharedPreferences.Editor editor;
    EditText mEmailtext,mpasswordtext,nameEt,phoneEt,confirm_passwordEt,addarNo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delevery_register);
        ...
        addarNo=findViewById(R.id.addarNo);
        ...
        bregister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String  addrno=addarNo.getText().toString().trim();
                ...
                else if(addrno.length()<10){
                    addarNo.setError("addar baga");
                    addarNo.setFocusable(true);
                }
                else {
                    editor.putString("deverl_username",email.trim());
                    editor.putString("deverl_password",password.trim());
                    editor.apply();
                    registerUser(email,password,nameEt.getText().toString(),phone,addrno);
        ...
        malreadytext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(DeleveryRegister.this, DeleveyLogin.class));
                finish();
            }
        });
    ...
    private void registerUser(String email, String password, final String name, final String phone, final String addrno) {
        ...
        mAuth.createUserWithEmailAndPassword(email, password)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            DatabaseReference reference=database.getReference("DeleveryBoy");
                            reference.child(uid).setValue(hashMap);

                            Toast.makeText(DeleveryRegister.this, "Registered with "+user.getEmail(), Toast.LENGTH_SHORT).show();
                            //TODO:goto order page
                             startActivity(new Intent(DeleveryRegister.this, DeleveryMain.class));
                            finish();
                        } else {
                            progressDialog.dismiss();
                            // If sign in fails, display a message to the user.
                            Toast.makeText(DeleveryRegister.this, "Authentication failed.", Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(@NonNull Exception e) {
                progressDialog.dismiss();
                Toast.makeText(DeleveryRegister.this,""+e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                FirebaseUser user = mAuth.getCurrentUser();
                                Toast.makeText(DeleveryRegister.this, "", Toast.LENGTH_SHORT).show();
                                startActivity(new Intent(DeleveryRegister.this, DeleveryMain.class));
                                finish();
                                ...
                                // If sign in fails, display a message to the user.
                                progressDialog.dismiss();
                                Toast.makeText(DeleveryRegister.this, "Authentication failed.",
